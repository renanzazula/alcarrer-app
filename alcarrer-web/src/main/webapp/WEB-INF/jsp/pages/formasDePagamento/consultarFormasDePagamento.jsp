...
<form:form method="post" modelAttribute="formasDePagamentoForm" action="abrirAlterarFormasDePagamento" name="formasDePagamentoForm">
	</br>
		
		<form:hidden path="codigo" id="codigo"/>
		<fieldset>
			<legend>Gerenciar Formas De Pagemento</legend>
					...
					<tbody>
						<c:forEach items="${list}" var="i">
							<tr>
								...
								<td class="porcentagemDesconto">${i.porcentagemDesconto}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
